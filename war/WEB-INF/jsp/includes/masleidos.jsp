...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
			...
			<div class="row">	
				<div class="span9">					
					<div class="title"><h3>Las cafeteras más vistas...</h3></div>
					...
					<!-- start: Row -->
		      		<div class="row">
						...
						<div class="span3">	
							<div class="picture">
								<a href="/cafeteras/${publicacionMVE.url}" title="${publicacionMVE.titulo}">
									<c:if test="${!empty publicacionMVE.lImages }">
									<img style="width: 270px;height: 340px;" class="lazy" data-original="${publicacionMVE.lImages[1]}" alt="${publicacionMVE.titulo}"/>
									</c:if>
									<div class="image-overlay-link"></div>
								</a>
							</div>
							<div class="item-description">
								<h4><a title="${publicacionMVE.titulo}" href="/cafeteras/${publicacionMVE.url}">${publicacionMVE.titulo}</a></h4>
								...
								<ul class="carousel">
									...
									<li class="testimonial">
										...
										<c:when test="${comentario.publicacion.tipo eq 'EB' }">
											<div class="testimonials-author">${comentario.nombre}, en <a title="${comentario.publicacion.titulo}" href="/cafeteras/${comentario.publicacion.url }">${comentario.publicacion.titulo}</a></div>
										</c:when>	
										<c:otherwise>
						...
						<div class="span3">	
							<div class="picture">
								<a href="/blog/${publicacionMVA.url}" title="${publicacionMVA.titulo}">
									...
									<img style="width: 270px;height: 340px;" class="lazy" data-original="${publicacionMVA.lImages[1]}" alt="${publicacionMVA.titulo}"/>
									</c:if>
									<div class="image-overlay-link"></div>
								</a>
							</div>
