...
<html lang="es">
	...
	<div itemscope itemtype="http://schema.org/Article" id="wrapper">
		<div style="display:none"><span itemprop="url">http://www.comprarcafeteraexpress.com/blog/${publicacion.url}</span><span itemprop="publisher">Comprar Cafetera Express</span></div>		
		<!--start: Container -->
    	<div class="container">
    		...
    		<ul class="breadcrumbs"><li class="home" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a name="header.breadcrumb.1" href="<%=result.toString()%>" itemprop="url" title="Página principal" class="migapan"><span itemprop="title">Página principal</span></a></li>
				<li class="crumb0" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><span>&nbsp;&gt;&nbsp;</span><a name="header.breadcrumb.2" href="<%=result.toString()%>/blog" itemprop="url" title="Blog Cafeteras" class="migapan"><span itemprop="title">Blog Cafeteras</span></a></li>
				...
				<div id="flex1" class="flexslider home">
					...
					<ul class="slides">
						...
						<c:if test="${status.count ne 3}">
							<li>
								<img style="width: 350px;height: 380px;" src="${imagen}"  alt="${publicacion.titulo}" />							
							</li>
						</c:if>
						</c:forEach>
			...
			<div class="row">
				...
				<div class="span10">
					<c:if test="${publicacion.disponible ne 'N'}">
						<h2><a href="/venta/principal/${publicacion.url}" onClick="ga('send', 'event', 'Venta', '${publicacion.url}', 'Boton Comprala Hoy');" class="button color launch" target="_blank">¡ Cómprala Hoy!</a></h2>				
					</c:if>
					<meta id="_articleBody7" itemprop="articleBody" content="${fn:replace(publicacion.articulo, "\"", "'")}">
					${publicacion.articulo}				
					<br>
					<c:if test="${publicacion.disponible ne 'N'}">
						<br><h2><a href="/venta/principal/${publicacion.url}" onClick="ga('send', 'event', 'Venta', '${publicacion.url}', 'Boton Comprala hoy al mejor precio');" class="button color launch">¡ Cómprala hoy al mejor precio!</a></h2>
					</c:if>					
					<br>
	...
	<div id="banAmazonHorizontal" style="position:absolute;top:990px;left:54px;">
		<div style="margin-left: 33px; margin-bottom: 12px;"><b>OFERTAS</b></div>
			...
			<div id="Amazon2art" class="iframe_wrap">
				<iframe src="http://rcm-eu.amazon-adsystem.com/e/cm?t=comprarcafeh-21&o=30&p=8&l=as1&asins=B003WGGYT0&ref=tf_til&fc1=666666&IS2=1&lt1=_blank&m=amazon&lc1=005580&bc1=EBF7F9&bg1=EBF7F9&f=ifr" style="width:120px;height:240px;" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>
	    	</div>
